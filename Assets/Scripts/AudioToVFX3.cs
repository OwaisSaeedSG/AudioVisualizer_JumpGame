...
public class AudioToVFX3 : MonoBehaviour
{
    ...
    public void BeatOcurred()
    {
        ...
        {
            transform.DOMoveZ(Mathf.Clamp((particleStartDepth - (baseBeatValue * frequencyList[5])), 0, 6), 0.1f, false).OnComplete(() =>
            {
                isMovementAllowed = false;
                transform.DOMoveZ(particleStartDepth, Mathf.Clamp((1 * baseBeatValue * frequencyList[5]), 0f, 1f), false).OnComplete(() =>
                {
